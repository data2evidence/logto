...
GRANT USAGE ON SCHEMA logto TO logto_tenant_alp_admin;
ALTER ROLE logto_tenant_alp_admin SET search_path = logto, logto, "$user";

---- Grant CRUD access to the group ----
grant select, insert, update, delete
  on all tables
  in schema logto
  to logto_tenant_alp_admin;

---- Security policies for tenants table ----

-- revoke all privileges
--  on table tenants
--  from logto_tenant_alp_admin;
...
GRANT USAGE ON SCHEMA logto TO logto_tenant_alp_default;
ALTER ROLE logto_tenant_alp_default SET search_path = logto, logto, "$user";

---- Grant CRUD access to the group ----
grant select, insert, update, delete
  on all tables
  in schema logto
  to logto_tenant_alp_default;
